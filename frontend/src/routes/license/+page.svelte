<div class="md:2xl:mx-96">
    ...
    <p class="font-bold">Die Inhalte auf dieser Seite sind vom Parlament Österreich mittels 
        <a class="link" href="https://creativecommons.org/licenses/by/4.0/deed.de">CC BY 4.0</a> lizensiert.</p> 
    <p>
    Urheber- und Zuschreibungsempfänger: Parlament Österreich, Dr.-Karl-Renner-Ring 3, 1017 Wien
    </p>
    Originalquelle: <a class="link" href="https://www.parlament.gv.at/recherchieren/plenarsitzungen/index.html">Plenarsitzungen des Nationalrats und Bundesrats</a>
    <br>
    Es wurden keine inhaltlichen Veränderungen an den Originalinhalten vorgenommen.
    <br>  <br>

    <p>
        Die verwendeten Inhalte werden von der österreichischen Parlamentsdirektion auf der Parlamentswebsite <a class="link" href="https://www.parlament.gv.at/">www.parlament.gv.at</a>
        zur Verfügung gestellt.  <a class="link" href="https://www.parlament.gv.at/recherchieren/open-data/daten-und-lizenz/index.html">Zum Open-Data Angebot des österreichischen Parlaments</a>
    </p> <br>

    Der Lizenzvermerk gilt explizit nicht für den Quellcode dieser Webapplikation.<br> <br>

    <h2 class="text-2xl font-normal leading-normal mt-0 mb-2 text-blue-800 break-words">Disclaimer</h2>
    ...
    <h2 class="text-2xl font-normal leading-normal mt-0 mb-2 text-blue-800 break-words">Haftungsausschluss</h2>
