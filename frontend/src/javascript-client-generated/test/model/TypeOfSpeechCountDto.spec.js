...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebApiVersion1000CultureneutralPublicKeyTokennull.TypeOfSpeechCountDto();
  });
  ...
  describe('TypeOfSpeechCountDto', function() {
    it('should create an instance of TypeOfSpeechCountDto', function() {
      // uncomment below and update the code to test TypeOfSpeechCountDto
      //var instance = new WebApiVersion1000CultureneutralPublicKeyTokennull.TypeOfSpeechCountDto();
      //expect(instance).to.be.a(WebApiVersion1000CultureneutralPublicKeyTokennull.TypeOfSpeechCountDto);
    });
