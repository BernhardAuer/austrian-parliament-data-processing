...
export class SpeechesMetaDataApi {
    ...
    */
    ...
    apiSpeechesMetaDataGetTypeOfSpeechesCountListGet(opts, callback) {
      ...
      let queryParams = {
        'PoliticalParty': this.apiClient.buildCollectionParam(opts['politicalParty'], 'multi'),'Legislature': opts['legislature'],'MeetingNumber': opts['meetingNumber'],'Topic': opts['topic']
      };
      let headerParams = {
